...
In [the v2 branch of this repo on GitHub](https://github.com/spatie/laravel-medialibrary-pro-app/tree/v2), you'll find a demo Laravel application in which you'll find examples of how to use Media Library Pro inside your Livewire components.
